...
public abstract class AbstractAzureMessagingAnnotationDrivenTests {
    ...
    public void testCustomConfiguration(ApplicationContext context) {
        ...
        assertEquals("Wrong endpoint type", SimpleAzureListenerEndpoint.class, endpoint.getClass());
    ...
    /**
     * Test for {@link AzureListenerRepeatableBean} and {@link AzureListenersBean} that validates that the
     * {@code @AzureListener} annotation is repeatable and generate one specific container per annotation.
     */
