...
spring.cloud.azure.config.managed-identity.client-id | Client id of the managed identity | No | null
spring.cloud.azure.config.managed-identity.object-id | Object id of the managed identity | No | null
