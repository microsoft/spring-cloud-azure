= Spring Cloud Azure Sql Database starter
...
4.  Update link:src/main/resources/application.properties[application.properties] to specify resource group, cache instance name and credential file path:
+
....
