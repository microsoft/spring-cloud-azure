...
3. Create https://docs.microsoft.com/en-us/azure/active-directory/managed-identities-azure-resources/how-to-manage-ua-identity-portal[User-assigned Managed Identity] in Azure Portal.

4. Create VM and add managed identity in Azure portal.
Learn how to create VM on Azure and add an managed identity from a VM using the Azure portal, please refer to https://docs.microsoft.com/en-us/azure/active-directory/managed-identities-azure-resources/qs-configure-portal-windows-vm[link].

5. Create project includes this sample in the VM on Azure.
...
== How to run
4. Update stream binding related properties in link:src/main/resources/application.properties[application.properties]
