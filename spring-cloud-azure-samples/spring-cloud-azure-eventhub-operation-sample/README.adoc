...
This code sample demonstrates how to use link:spring-integration-azure/spring-integration-eventhub/src/main/java/com/microsoft/azure/spring/integration/eventhub/EventHubOperation.java[Event Hub Operation].
