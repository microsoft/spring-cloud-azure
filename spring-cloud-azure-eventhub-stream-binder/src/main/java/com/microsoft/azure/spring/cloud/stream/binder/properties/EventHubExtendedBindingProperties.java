 ...
 * @author Warren Zhu
 */
@ConfigurationProperties("spring.cloud.stream.azure.eventhub")
public class EventHubExtendedBindingProperties
    ...
    private Map<String, EventHubBindingProperties> bindings = new HashMap<>();
    ...
    public EventHubProducerProperties getExtendedProducerProperties(String channelName) {
        ...
        return new EventHubProducerProperties();
    }
}
