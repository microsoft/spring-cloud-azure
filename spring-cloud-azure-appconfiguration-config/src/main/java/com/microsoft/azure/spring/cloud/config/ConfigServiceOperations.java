...
public interface ConfigServiceOperations {
     ...
     * @return all key-value items List&lt;{@link KeyValueItem}&gt; which match given condition, result is sorted by the
     ...
     * @param storeName the store name against which to query
     * @param queryOptions the options used to query the keys
     * @return all key-value items List&lt;{@link KeyValueItem}&gt; which match given condition
     */
