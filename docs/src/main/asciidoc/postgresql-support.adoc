...
NOTE: Get more information about link:https://review.learn.microsoft.com/azure/developer/java/spring-framework/deploy-passwordless-spring-database-app?branch=pr-en-us-3511&tabs=postgresql[Deploying Spring Application Connected to Azure Database Passwordlessly to Azure Spring Apps]
