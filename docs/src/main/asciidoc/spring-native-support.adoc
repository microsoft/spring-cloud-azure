...
Please refer to link:https://github.com/Azure-Samples/azure-spring-boot-samples/tree/main/spring-native/storage-blob[storage-blob].

Here are other verified samples that support Spring Native, see link:https://github.com/Azure-Samples/azure-spring-boot-samples/tree/main#run-samples-based-on-spring-native[Spring Cloud Azure Samples] for more details.
