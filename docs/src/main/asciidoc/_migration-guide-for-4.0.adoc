...
|N/A |spring-cloud-azure-autoconfigure |Newly added Spring Cloud Azure AutoConfigure artifact, including all autoconfiguration for SDK clients, Spring Security support, Spring Data support and Spring Integration support.
...
|N/A |spring-cloud-azure-starter |Newly added Core Spring Cloud Azure starter, including autoconfiguration support. 
