...
|com.azure.spring.integration.core.api.reactor.DefaultMessageHandler |com.azure.spring.integration.core.DefaultMessageHandler
...
|NONE |com.azure.spring.messaging.eventhubs.core.EventHubsProcessorContainer
|===
...
.Dropped class from azure-spring-cloud-starter-storage-queue to spring-cloud-azure-starter-integration-storage-queue
[options="header"]
|===
| Dropped legacy class
...
.Dropped class from azure-spring-cloud-stream-binder-eventhubs to spring-cloud-azure-stream-binder-eventhubs
[options="header"]
|===
| Dropped legacy class
|com.azure.spring.integration.core.api.Checkpointer
|com.azure.spring.integration.core.api.SendOperation
|com.azure.spring.integration.core.api.BatchSendOperation
|com.azure.spring.integration.core.api.reactor.BatchSendOperation
|com.azure.spring.integration.core.api.RxSubscribeByGroupOperation
|com.azure.spring.integration.core.api.RxSendOperation
|com.azure.spring.integration.core.api.RxSubscribeOperation
|com.azure.spring.integration.eventhub.api.EventHubRxOperation
|com.azure.spring.integration.core.api.reactor.ReceiveOperation
|com.azure.spring.integration.eventhub.impl.AbstractEventHubTemplate
|com.azure.spring.integration.eventhub.impl.EventHubRxTemplate
|com.azure.spring.integration.core.AbstractInboundChannelAdapter
|com.azure.spring.integration.eventhub.impl.EventHubProcessor
|com.azure.spring.integration.eventhub.support.EventHubProcessorSupport
|com.azure.spring.integration.eventhub.support.EventHubTestOperation
|com.azure.spring.integration.eventhub.support.RxEventHubTestOperation
|===
...
|com.azure.spring.servicebus.stream.binder.properties.ServiceBusTopicExtendedBindingProperties, com.azure.spring.servicebus.stream.binder.properties.ServiceBusQueueExtendedBindingProperties | com.azure.spring.cloud.stream.binder.servicebus.core.properties.ServiceBusExtendedBindingProperties
...
|com.azure.spring.servicebus.stream.binder.ServiceBusQueueHealthIndicator, com.azure.spring.servicebus.stream.binder.ServiceBusTopicHealthIndicator | com.azure.spring.cloud.stream.binder.servicebus.ServiceBusHealthIndicator
|com.azure.spring.servicebus.stream.binder.provisioning.ServiceBusQueueChannelResourceManagerProvisioner, com.azure.spring.servicebus.stream.binder.provisioning.ServiceBusTopicChannelResourceManagerProvisioner |com.azure.spring.cloud.stream.binder.servicebus.core.provisioning.ServiceBusChannelResourceManagerProvisioner
|===
