...
|azure-spring-cloud-stream-binder-servicebus-queue |spring-cloud-azure-stream-binder-servicebus |This artifact has been deleted with all funtionality be merged into the `spring-cloud-azure-stream-binder` artifact.
|azure-spring-cloud-stream-binder-servicebus-topic |spring-cloud-azure-stream-binder-servicebus |This artifact has been deleted with all funtionality be merged into the `spring-cloud-azure-stream-binder` artifact.
...
.property name mapping of spring-cloud-azure-starter-keyvault-secrets
[cols="<30,<~"]
|===
...
.property name mapping of spring-cloud-azure-starter-storage-blob
[cols="<30,<~"]
|===
|Legacy properties |Morden properties 
...
.property name mapping of spring-cloud-azure-starter-storage-file-share
[cols="<30,<~"]
|===
|Legacy properties |Morden properties 
...
.property name mapping of spring-cloud-azure-starter-integration-eventhubs
[cols="<30,<~"]
|===
|Legacy properties | Morden properties 
...
.property name mapping of spring-cloud-azure-starter-integration-servicebus
[cols="<30,<~"]
|===
...
.property name mapping of spring-cloud-azure-starter-integration-storage-queue
[cols="<30,<~"]
|===
|Legacy properties |Morden properties 
...
.property name mapping of spring-cloud-azure-stream-binder-servicebus
[cols="<30,<~"]
|===
|Legacy properties |Modern properties
...
.class mapping of spring-cloud-azure-starter-active-directory
[cols="<~,<~"]
|===
...
.class mapping of spring-cloud-azure-starter-active-directory-b2c
[cols="<~,<~"]
|===
|Legacy class |Modern class 
...
.class mapping of spring-cloud-azure-starter-integration-eventhubs
[cols="<~,<~"]
|===
|Legacy class |Modern class 
...
.class mapping of spring-cloud-azure-starter-integration-storage-queue
[cols="<~,<~"]
|===
|Legacy class |Modern class
...
.class mapping of spring-cloud-azure-stream-binder-eventhubs
[cols="<~,<~"]
|===
|Legacy class |Modern class
...
.class mapping of spring-cloud-azure-stream-binder-servicebus
[cols="<~,<~"]
|===
|Legacy class |Modern class 
