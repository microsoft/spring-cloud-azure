...
|azure-spring-cloud-starter-eventhubs-kafka |N/A |Deleted this artifact. For using kafka, just add spring kafka, spring-cloud-azure-resourcemanager and spring-cloud-azure-starter. Please see <<kafka-support.adoc#kafka-support, Kafka Support>> for more information about usage.
...
|azure-spring-cloud-stream-binder-eventhubs |spring-cloud-azure-stream-binder-eventhubs |Renamed the artifact. This artifact has been refactored using new redesign, mainly `spring-cloud-azure-stream-binder-eventhubs` and `spring-cloud-azure-stream-binder-eventhubs-core`.
|azure-spring-cloud-stream-binder-service-core |spring-cloud-azure-stream-binder-servicebus-core | Renamed the artifact.
|azure-spring-cloud-stream-binder-servicebus-queue |spring-cloud-azure-stream-binder-servicebus |Deleted this artifact with merging all functionalities into the `spring-cloud-azure-stream-binder` artifact.
|azure-spring-cloud-stream-binder-servicebus-topic |spring-cloud-azure-stream-binder-servicebus |Deleted this artifact with merging all functionalities into the `spring-cloud-azure-stream-binder` artifact.
...
|N/A |spring-cloud-azure-stream-binder-eventhubs-core | The newly added Spring Cloud Stream core artifact for Event Hubs.
|===
...
global token credential as well as providing the token credential at each service level. But credential isn't required
...
. New property `spring.cloud.azure.active-directory.enabled=true` is required to enable related features.
...
.Removed property from azure-spring-boot-starter-active-directory
[options="header"]
|===
| Removed properties
...
. New property `spring.cloud.azure.active-directory.b2c.enabled=true` is required to enable related features.
...
.Removed property from azure-spring-boot-starter-active-directory-b2c
[options="header"]
|===
| Removed properties
...
* Per prefix of `spring.cloud.azure.eventhub`, prefix is re-defined as
`spring.cloud.azure.eventhubs`

* Per prefix of `spring.cloud.stream.binders.&lt;eventhub-name&gt;.environment.spring.cloud.azure`: +
prefix change from: +
...
* Per prefix of `spring.cloud.stream.eventhub`: +
prefix changed from +
...
IMPORTANT: Legacy binder libaries are `azure-spring-cloud-stream-binder-servicebus-queue` and `azure-spring-cloud-stream-binder-servicebus-topic`, and now they're merged into one `spring-cloud-azure-stream-binder-servicebus`.
...
|spring.cloud.stream.servicebus.bindings.<binding-name>.consumer.checkpoint-mode | spring.cloud.stream.servicebus.bindings.<binding-name>.consumer.auto-complete | Enabling auto-complete is equal to `RECORD` checkpoint mode, and oppositely the `MANUAL` mode.
|===
...
|com.azure.spring.aad.implementation.constants.AADTokenClaim |com.azure.spring.cloud.autoconfigure.aad.implementation.constants.AadJwtClaimNames
|com.azure.spring.aad.implementation.constants.AuthorityPrefix |com.azure.spring.cloud.autoconfigure.aad.implementation.constants.AuthorityPrefix
|com.azure.spring.aad.implementation.jackson.AADClientRegistrationDeserializer |com.azure.spring.cloud.autoconfigure.aad.implementation.jackson.AadClientRegistrationDeserializer
|com.azure.spring.aad.implementation.jackson.AADClientRegistrationMixin |com.azure.spring.cloud.autoconfigure.aad.implementation.jackson.AadClientRegistrationMixin
|com.azure.spring.aad.implementation.jackson.AADOAuth2ClientJackson2Module |com.azure.spring.cloud.autoconfigure.aad.implementation.jackson.AadOAuth2ClientJackson2Module
|com.azure.spring.aad.implementation.jackson.JsonNodeUtils |com.azure.spring.cloud.autoconfigure.aad.implementation.jackson.JsonNodeUtils
|com.azure.spring.aad.implementation.jackson.SerializerUtils |com.azure.spring.cloud.autoconfigure.aad.implementation.jackson.SerializerUtils
|com.azure.spring.aad.implementation.jackson.StdConverters |com.azure.spring.cloud.autoconfigure.aad.implementation.jackson.StdConverters
|com.azure.spring.aad.webapi.validator.AADJwtIssuerValidator |com.azure.spring.cloud.autoconfigure.aad.implementation.webapi.validator.AadJwtIssuerValidator
|com.azure.spring.aad.webapi.AADJwtBearerTokenAuthenticationConverter |com.azure.spring.cloud.autoconfigure.aad.implementation.webapi.AadJwtBearerTokenAuthenticationConverter
|com.azure.spring.aad.webapi.AADOBOOAuth2AuthorizedClientProvider |com.azure.spring.cloud.autoconfigure.aad.implementation.webapi.AadOboOAuth2AuthorizedClientProvider
|com.azure.spring.aad.webapi.AADResourceServerConfiguration |com.azure.spring.cloud.autoconfigure.aad.configuration.AadResourceServerConfiguration
...
|com.azure.spring.aad.webapp.AADAzureDelegatedOAuth2AuthorizedClientProvider |com.azure.spring.cloud.autoconfigure.aad.implementation.webapp.AadAzureDelegatedOAuth2AuthorizedClientProvider
|com.azure.spring.aad.webapp.AADHandleConditionalAccessFilter |com.azure.spring.cloud.autoconfigure.aad.implementation.webapp.AadHandleConditionalAccessFilter
|com.azure.spring.aad.webapp.AADOAuth2AuthorizationCodeGrantRequestEntityConverter |com.azure.spring.cloud.autoconfigure.aad.implementation.webapp.AadOAuth2AuthorizationCodeGrantRequestEntityConverter
|com.azure.spring.aad.webapp.AADOAuth2AuthorizationRequestResolver |com.azure.spring.cloud.autoconfigure.aad.implementation.webapp.AadOAuth2AuthorizationRequestResolver
|com.azure.spring.aad.webapp.AADOAuth2UserService |com.azure.spring.cloud.autoconfigure.aad.implementation.webapp.AadOAuth2UserService
|com.azure.spring.aad.webapp.AADWebApplicationConfiguration |com.azure.spring.cloud.autoconfigure.aad.configuration.AadWebApplicationConfiguration
...
|com.azure.spring.aad.webapp.AzureClientRegistration |com.azure.spring.cloud.autoconfigure.aad.implementation.webapp.AzureClientRegistration
|com.azure.spring.aad.webapp.GraphClient |com.azure.spring.cloud.autoconfigure.aad.implementation.graph.GraphClient
|com.azure.spring.aad.webapp.GroupInformation |com.azure.spring.cloud.autoconfigure.aad.implementation.graph.GroupInformation
...
|com.azure.spring.aad.AADClientRegistrationRepository |com.azure.spring.cloud.autoconfigure.aad.implementation.oauth2.AadClientRegistrationRepository
|com.azure.spring.aad.AADIssuerJWSKeySelector |com.azure.spring.cloud.autoconfigure.aad.implementation.jwt.AadIssuerJwsKeySelector
|com.azure.spring.aad.AADJwtDecoderProviderConfiguration |com.azure.spring.cloud.autoconfigure.aad.implementation.jwt.AadJwtDecoderProviderConfiguration
|com.azure.spring.aad.AADJwtGrantedAuthoritiesConverter |com.azure.spring.cloud.autoconfigure.aad.implementation.jwt.AadJwtGrantedAuthoritiesConverter
|com.azure.spring.aad.AADOAuth2AuthenticatedPrincipal |com.azure.spring.cloud.autoconfigure.aad.implementation.oauth2.AadOAuth2AuthenticatedPrincipal
|com.azure.spring.aad.AADOAuth2ClientConfiguration |com.azure.spring.cloud.autoconfigure.aad.configuration.AadOAuth2ClientConfiguration
|com.azure.spring.aad.AADTrustedIssuerRepository |com.azure.spring.cloud.autoconfigure.aad.AadTrustedIssuerRepository
|com.azure.spring.aad.AbstractOAuth2AuthorizationCodeGrantRequestEntityConverter |com.azure.spring.cloud.autoconfigure.aad.implementation.oauth2.AbstractOAuth2AuthorizationCodeGrantRequestEntityConverter
|com.azure.spring.aad.JacksonHttpSessionOAuth2AuthorizedClientRepository |com.azure.spring.cloud.autoconfigure.aad.implementation.oauth2.JacksonHttpSessionOAuth2AuthorizedClientRepository
|com.azure.spring.autoconfigure.aad.AADAppRoleStatelessAuthenticationFilter |com.azure.spring.cloud.autoconfigure.aad.filter.AadAppRoleStatelessAuthenticationFilter
|com.azure.spring.autoconfigure.aad.AADAuthenticationFilter |com.azure.spring.cloud.autoconfigure.aad.filter.AadAuthenticationFilter
|com.azure.spring.autoconfigure.aad.AADAuthenticationFilterAutoConfiguration |com.azure.spring.cloud.autoconfigure.aad.AadAuthenticationFilterAutoConfiguration
|com.azure.spring.autoconfigure.aad.AADAuthenticationProperties |com.azure.spring.cloud.autoconfigure.aad.properties.AadAuthenticationProperties
|com.azure.spring.autoconfigure.aad.AADAutoConfiguration |com.azure.spring.cloud.autoconfigure.aad.AadAutoConfiguration
|com.azure.spring.autoconfigure.aad.AzureADGraphClient |com.azure.spring.cloud.autoconfigure.aad.implementation.graph.AzureADGraphClient
|com.azure.spring.autoconfigure.aad.Constants |com.azure.spring.cloud.autoconfigure.aad.implementation.constants.Constants
|com.azure.spring.autoconfigure.aad.JacksonObjectMapperFactory |com.azure.spring.cloud.autoconfigure.aad.implementation.util.JacksonObjectMapperFactory
|com.azure.spring.autoconfigure.aad.Membership |com.azure.spring.cloud.autoconfigure.aad.implementation.graph.Membership
|com.azure.spring.autoconfigure.aad.Memberships |com.azure.spring.cloud.autoconfigure.aad.implementation.graph.Memberships
...
|com.azure.spring.autoconfigure.condition.aad.ClientRegistrationCondition |com.azure.spring.cloud.autoconfigure.aad.implementation.conditions.ClientRegistrationCondition
|com.azure.spring.autoconfigure.condition.aad.ResourceServerCondition |com.azure.spring.cloud.autoconfigure.aad.implementation.conditions.ResourceServerCondition
|com.azure.spring.autoconfigure.condition.aad.WebApplicationCondition |com.azure.spring.cloud.autoconfigure.aad.implementation.conditions.WebApplicationCondition
|===

.Removed class from azure-spring-boot-starter-active-directory
[options="header"]
|===
...
|com.azure.spring.autoconfigure.b2c.AADB2CAutoConfiguration |com.azure.spring.cloud.autoconfigure.aadb2c.AadB2cAutoConfiguration
|com.azure.spring.autoconfigure.b2c.AADB2CClientRegistrationRepository |com.azure.spring.cloud.autoconfigure.aadb2c.implementation.AadB2cClientRegistrationRepository
|com.azure.spring.autoconfigure.b2c.AADB2CConditions |com.azure.spring.cloud.autoconfigure.aadb2c.implementation.AadB2cConditions
|com.azure.spring.autoconfigure.b2c.AADB2CConfigurationException |com.azure.spring.cloud.autoconfigure.aadb2c.implementation.AadB2cConfigurationException
|com.azure.spring.autoconfigure.b2c.AADB2CJwtBearerTokenAuthenticationConverter |com.azure.spring.cloud.autoconfigure.aad.implementation.webapi.AadJwtBearerTokenAuthenticationConverter
...
|com.azure.spring.autoconfigure.b2c.AADB2COAuth2AuthorizationCodeGrantRequestEntityConverter |com.azure.spring.cloud.autoconfigure.aadb2c.implementation.AadB2cOAuth2AuthorizationCodeGrantRequestEntityConverter
|com.azure.spring.autoconfigure.b2c.AADB2COAuth2ClientConfiguration |com.azure.spring.cloud.autoconfigure.aadb2c.configuration.AadB2cOAuth2ClientConfiguration
...
|com.azure.spring.autoconfigure.b2c.AADB2CResourceServerAutoConfiguration |com.azure.spring.cloud.autoconfigure.aadb2c.AadB2cResourceServerAutoConfiguration
...
|com.azure.spring.autoconfigure.b2c.AADB2CURL |com.azure.spring.cloud.autoconfigure.aadb2c.implementation.AadB2cUrl
...
|===
|Legacy class |Modern class
|com.azure.spring.integration.core.EventHubsHeaders |com.azure.spring.messaging.eventhubs.support.EventHubsHeaders
...
|com.azure.spring.integration.eventhub.api.EventHubOperation |com.azure.spring.messaging.eventhubs.core.EventHubsTemplate
|NONE |com.azure.spring.messaging.eventhubs.core.listener.EventHubsMessageListenerContainer
|===
...
|com.azure.spring.integration.storage.queue.factory.StorageQueueClientFactory |com.azure.spring.messaging.storage.queue.core.factory.StorageQueueClientFactory
|com.azure.spring.integration.storage.queue.factory.DefaultStorageQueueClientFactory |com.azure.spring.messaging.storage.queue.implementation.factory.DefaultStorageQueueClientFactory
...
.Removed class from azure-spring-cloud-starter-storage-queue to spring-cloud-azure-starter-integration-storage-queue
[options="header"]
|===
| Removed legacy class
...
|com.azure.spring.integration.core.api.reactor.SendOperation |com.azure.spring.messaging.core.SendOperation
|com.azure.spring.integration.core.api.reactor.DefaultMessageHandler |com.azure.spring.integration.core.handler.DefaultMessageHandler
|com.azure.spring.integration.eventhub.impl.EventHubTemplate |com.azure.spring.messaging.eventhubs.core.EventHubsTemplate
|com.azure.spring.integration.eventhub.inbound.EventHubInboundChannelAdapter |com.azure.spring.integration.eventhubs.inbound.EventHubsInboundChannelAdapter
|===

==== From azure-spring-cloud-stream-binder-servicebus-queue and azure-spring-cloud-stream-binder-servicebus-topic to spring-cloud-azure-stream-binder-servicebus

.Class mapping from azure-spring-cloud-stream-binder-servicebus to spring-cloud-azure-stream-binder-servicebus
[cols="<~,<~", options="header"]
|===
|Legacy class |Modern class
|com.azure.spring.servicebus.stream.binder.properties.ServiceBusQueueExtendedBindingProperties |com.azure.spring.cloud.stream.binder.servicebus.core.properties.ServiceBusExtendedBindingProperties
|com.azure.spring.servicebus.stream.binder.properties.ServiceBusTopicExtendedBindingProperties |com.azure.spring.cloud.stream.binder.servicebus.core.properties.ServiceBusExtendedBindingProperties
|com.azure.spring.servicebus.stream.binder.properties.ServiceBusConsumerProperties |com.azure.spring.cloud.stream.binder.servicebus.core.properties.ServiceBusConsumerProperties
|com.azure.spring.servicebus.stream.binder.properties.ServiceBusProducerProperties |com.azure.spring.cloud.stream.binder.servicebus.core.properties.ServiceBusProducerProperties
|com.azure.spring.servicebus.stream.binder.properties.ServiceBusBindingProperties |com.azure.spring.cloud.stream.binder.servicebus.core.properties.ServiceBusBindingProperties
|com.azure.spring.servicebus.stream.binder.ServiceBusMessageChannelBinder |com.azure.spring.cloud.stream.binder.servicebus.ServiceBusMessageChannelBinder
|com.azure.spring.servicebus.stream.binder.ServiceBusQueueHealthIndicator |com.azure.spring.cloud.stream.binder.servicebus.ServiceBusHealthIndicator
|com.azure.spring.servicebus.stream.binder.ServiceBusTopicHealthIndicator |com.azure.spring.cloud.stream.binder.servicebus.ServiceBusHealthIndicator
|com.azure.spring.servicebus.stream.binder.provisioning.ServiceBusQueueChannelResourceManagerProvisioner |com.azure.spring.cloud.stream.binder.servicebus.core.provisioning.ServiceBusChannelResourceManagerProvisioner
| com.azure.spring.servicebus.stream.binder.provisioning.ServiceBusTopicChannelResourceManagerProvisioner |com.azure.spring.cloud.stream.binder.servicebus.core.provisioning.ServiceBusChannelResourceManagerProvisioner
|===
