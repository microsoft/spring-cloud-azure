...
|org.springframework.boot:spring-boot-starter-validation |Please include the validation starter if you want to use Hibernate Validator.
|org.springframework.boot:spring-boot-starter-webflux |Please include the webflux starter if you want to use AAD condition access.
|===
...
|com.azure.spring.autoconfigure.aad.AzureADGraphClient |com.azure.spring.cloud.autoconfigure.aad.implementation.graph.AzureAadGraphClient
...
|retry-options.retry-mode |Dropped, will be configured according to retry.backoff.multiplier |N/A
|===
