...
===== Introduction
Please refer to the <<#migration-guide-introduction, introduction>> section for details.

===== Migration benefits
Please refer to the <<#migration-guide-benefits, migration benefits>> section for details.

===== Naming changes
Please refer to the <<#migration-guide-naming, naming changes>> section for details.

===== Bom
Please refer to the <<#migration-guide-bom, bom>> section for details.
...
===== Authentication
Please refer to the <<#migration-guide-authentication, authentication>> section for details.

===== Configuration properties

====== Properties migration
Please refer to the <<#migration-guide-properties-migration, properties migration>> section for how to leverage `spring-boot-properties-migrator` during migration.

====== Global configurations
Please refer to the <<#migration-guide-global-configurations, global configurations>> section for the global and common configuration changes.
