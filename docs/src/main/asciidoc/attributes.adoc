...
:spring-cloud-azure-native-configuration: https://github.com/Azure/azure-sdk-for-java/tree/main/sdk/spring/spring-cloud-azure-native-configuration
:spring-cloud-azure-native-configuration-version: 4.0.0-beta.1
:spring-cloud-azure-sample: spring-cloud-azure-sample
