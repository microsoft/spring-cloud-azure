...
For those new to the Spring Cloud Azure 4.0 libraries, please refer to the link:reference-doc[Spring Cloud Azure 4.0 Reference Doc] rather than this guide.
...
while other `Data` related roles are required for messaging operations, please refer to link:reference-doc#authorize-access-with-azure-active-directory[Authorize access with Azure AD] to make sure the security principal has been granted the sufficient permission to access the Azure resource.
