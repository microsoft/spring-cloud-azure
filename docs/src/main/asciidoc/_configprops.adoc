...
|spring.jms.servicebus.idle-timeout | `30m` | 
...
|spring.jms.servicebus.prefetch-policy.all | `0` | 
|spring.jms.servicebus.prefetch-policy.durable-topic-prefetch | `0` | 
|spring.jms.servicebus.prefetch-policy.queue-browser-prefetch | `0` | 
|spring.jms.servicebus.prefetch-policy.queue-prefetch | `0` | 
|spring.jms.servicebus.prefetch-policy.topic-prefetch | `0` | 
