...
|spring.cloud.azure.compatibility-verifier.compatible-boot-versions | `3.0.0` | Comma-delimited list of Spring Boot versions that are compatible with current Spring Cloud Azure's version.
...
|spring.cloud.azure.servicebus.processor.auto-startup | `true` | Whether to automatically start the processor after initialization.
