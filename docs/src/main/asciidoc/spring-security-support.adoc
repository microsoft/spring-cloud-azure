...
To connect Azure AD via proxy, you need provide a `RestTemplateCustomizer` bean. Please refer to link:index.html#connecting-to-azure-ad-via-proxy[Web application connecting to Azure AD via proxy] to get more information.
