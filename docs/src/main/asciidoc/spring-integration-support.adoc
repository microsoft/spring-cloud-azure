...
Please refer to this https://github.com/Azure-Samples/azure-spring-boot-samples/tree/spring-cloud-azure_4.0/eventhubs[sample project] to learn how to use Event Hubs integration.
...
Please refer to this https://github.com/Azure-Samples/azure-spring-boot-samples/tree/spring-cloud-azure_4.0/servicebus[sample project] to learn how to use Service Bus integration.
...
Please refer to this https://github.com/Azure-Samples/azure-spring-boot-samples/tree/spring-cloud-azure_4.0/storage/[sample project] illustrating how to use Storage Queue integration.
